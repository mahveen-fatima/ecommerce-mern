  ...
  return (
    <div className='px-4 sm:px-[5vw] md:px-[7vw] lg:px-[5vw] font-helvetica'>
        ...
        <div className="relative inset-0 flex flex-col justify-center items-center mt-7 font-helvetica text-[#111111]">
            ...
            <button className="mt-6 px-4 py-2 bg-[#111111] text-white font-semibold rounded-full shadow-lg hover:bg-gray-900 transition-all poppins-regular roboto-regular">
            Shop Now
            </button>
      </div>
